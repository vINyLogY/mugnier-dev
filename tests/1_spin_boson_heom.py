...
if __name__ == '__main__':
    ...
    parser.add_argument('--include_brownian', type=bool, default=True)
    ...
    parser.add_argument('--n_ltc', type=int, default=1)

    parser.add_argument('--dim', type=int, default=10)
    parser.add_argument('--htd_method', type=str, default='Naive')
